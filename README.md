...
| Reconcile or correct an import | **Activity** → select that document-processing item | Shows **What this document changed** independently of narrative-report retention, with human source/exact-wording links; correct/remove a value or safely undo the document's direct structured changes |
